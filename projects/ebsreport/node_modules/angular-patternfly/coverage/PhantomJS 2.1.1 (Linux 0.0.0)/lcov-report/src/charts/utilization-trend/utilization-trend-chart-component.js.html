...
<html lang="en">
<head>
    <title>Code coverage report for src/charts/utilization-trend/utilization-trend-chart-component.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/charts/utilization-trend/utilization-trend-chart-component.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/charts/utilization-trend/</a> &#187; utilization-trend-chart-component.js</div>
</div>
<div class="body">
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (ctrl.donutConfig.units === undefined) {
<span class="cstat-no" title="statement not covered" >        ctrl.donutConfig.units = ctrl.config.units;</span>
      }
&nbsp;
...
&nbsp;
      ctrl.config.units = ctrl.config.units || <span class="branch-1 cbranch-no" title="branch not covered" >ctrl.units;</span>
&nbsp;
