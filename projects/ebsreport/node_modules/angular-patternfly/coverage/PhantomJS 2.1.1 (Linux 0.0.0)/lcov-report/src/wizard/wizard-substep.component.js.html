...
<html lang="en">
<head>
    <title>Code coverage report for src/wizard/wizard-substep.component.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/wizard/wizard-substep.component.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">src/wizard/</a> &#187; wizard-substep.component.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">/** @ngdoc directive
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (changesObj.okToNavAway) {
<span class="cstat-no" title="statement not covered" >        ctrl.step.okToNavAway = changesObj.okToNavAway.currentValue;</span>
      }
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (changesObj.allowClickNav) {
<span class="cstat-no" title="statement not covered" >        ctrl.step.allowClickNav = changesObj.allowClickNav.currentValue;</span>
      }
    };
&nbsp;
