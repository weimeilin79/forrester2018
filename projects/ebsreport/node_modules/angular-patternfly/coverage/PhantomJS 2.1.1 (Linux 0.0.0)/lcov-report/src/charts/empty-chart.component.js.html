...
<html lang="en">
<head>
    <title>Code coverage report for src/charts/empty-chart.component.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/charts/empty-chart.component.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">src/charts/</a> &#187; empty-chart.component.js</div>
</div>
<div class="body">
...
&nbsp;
    ctrl.$onChanges =  function (changesObj) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (changesObj.chartHeight) {
        ctrl.setSizeStyles();
      }
    };
  }
