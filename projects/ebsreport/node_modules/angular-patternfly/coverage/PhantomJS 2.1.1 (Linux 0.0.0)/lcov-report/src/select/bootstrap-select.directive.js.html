...
<html lang="en">
<head>
    <title>Code coverage report for src/select/bootstrap-select.directive.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/select/bootstrap-select.directive.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">src/select/</a> &#187; bootstrap-select.directive.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">angular.module('patternfly.select').directive('pfBootstrapSelect', function () {
  'use strict';
&nbsp;
  return {
    restrict: 'A',
...
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (attrs.ngOptions) {
...
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (attrs.ngModel) {
