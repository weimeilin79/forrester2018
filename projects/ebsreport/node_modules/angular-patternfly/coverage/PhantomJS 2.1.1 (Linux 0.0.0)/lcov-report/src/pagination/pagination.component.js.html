...
<html lang="en">
<head>
    <title>Code coverage report for src/pagination/pagination.component.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/pagination/pagination.component.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">92.73% <small>(51 / 55)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">src/pagination/</a> &#187; pagination.component.js</div>
</div>
<div class="body">
...
&nbsp;
    ctrl.$onChanges = function (changesObj) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (changesObj.numTotalItems &amp;&amp; !changesObj.numTotalItems.isFirstChange()) {
<span class="cstat-no" title="statement not covered" >        ctrl.lastPageNumber = getLastPageNumber();</span>
<span class="cstat-no" title="statement not covered" >        ctrl.gotoFirstPage();</span>
      }
    };
&nbsp;
    ctrl.onPageSizeChange = function (newPageSize) {
      ...
      ctrl.lastPageNumber = getLastPageNumber();
      ctrl.gotoFirstPage();
      <span class="missing-if-branch" title="else path not taken" >E</span>if (ctrl.updatePageSize) {
        ctrl.updatePageSize({
          $event: {
...
&nbsp;
    ctrl.onPageNumberChange = function () {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (newPageNumber &gt; ctrl.lastPageNumber) {
<span class="cstat-no" title="statement not covered" >        updatePageNumber(ctrl.lastPageNumber);</span>
      } else <span class="missing-if-branch" title="if path not taken" >I</span>if (newPageNumber &lt; 1 || isNaN(ctrl.pageNumber)) {
<span class="cstat-no" title="statement not covered" >        updatePageNumber(1);</span>
      } else {
...
&nbsp;
    ctrl.gotoPreviousPage = function () {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (ctrl.pageNumber !== 1) {
        updatePageNumber(ctrl.pageNumber - 1);
      }
    };
&nbsp;
    ctrl.gotoNextPage = function () {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (ctrl.pageNumber &lt; ctrl.lastPageNumber) {
        updatePageNumber(ctrl.pageNumber + 1);
      }
    };
&nbsp;
...
&nbsp;
    function updatePageNumber (newPageNumber) {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (ctrl.updatePageNumber) {
