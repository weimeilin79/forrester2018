...
<html lang="en">
<head>
    <title>Code coverage report for src/charts/sparkline/sparkline-chart.component.js</title>
    <meta charset="utf-8">
...
<div class="header medium">
    <h1>Code coverage report for <span class="entity">src/charts/sparkline/sparkline-chart.component.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/charts/sparkline/</a> &#187; sparkline-chart.component.js</div>
</div>
<div class="body">
...
&nbsp;
      ...
      if (ctrl.sparklineChartId === undefined) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (ctrl.config.chartId) {
...
&nbsp;
      if (ctrl.showXAxis === undefined) {
        ctrl.showXAxis = (ctrl.config.showAxis !== undefined) &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >ctrl.config.showAxis;</span>
      }
&nbsp;
      if (ctrl.showYAxis === undefined) {
        ctrl.showYAxis = (ctrl.config.showAxis !== undefined) &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >ctrl.config.showAxis;</span>
      }
&nbsp;
    ...
    ctrl.sparklineTooltip = function () {
      return {
        contents: function (d) {
          ...
          var percentUsed = 0;
&nbsp;
          <span class="missing-if-branch" title="else path not taken" >E</span>if (ctrl.config.tooltipFn) {
            tipRows = ctrl.config.tooltipFn(d);
          } else {
<span class="cstat-no" title="statement not covered" >            switch (ctrl.config.tooltipType) {</span>
            case 'usagePerDay':
<span class="cstat-no" title="statement not covered" >              if (ctrl.chartData.dataAvailable !== false &amp;&amp; ctrl.chartData.total &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >                percentUsed = Math.round(d[0].value / ctrl.chartData.total * 100.0);</span>
              }
<span class="cstat-no" title="statement not covered" >              tipRows =</span>
                '&lt;tr&gt;' +
...
<span class="cstat-no" title="statement not covered" >              break;</span>
            default:
<span class="cstat-no" title="statement not covered" >              tipRows = patternfly.c3ChartDefaults().getDefaultSparklineTooltip().contents(d);</span>
            }
          }
...
<span class="cstat-no" title="statement not covered" >          var chartBox;</span>
<span class="cstat-no" title="statement not covered" >          var graphOffsetX;</span>
<span class="cstat-no" title="statement not covered" >          var x;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          try {</span>
<span class="cstat-no" title="statement not covered" >            center = parseInt(element.getAttribute('x'));</span>
<span class="cstat-no" title="statement not covered" >            top = parseInt(element.getAttribute('y'));</span>
<span class="cstat-no" title="statement not covered" >            chartBox = document.querySelector('#' + ctrl.sparklineChartId).getBoundingClientRect();</span>
<span class="cstat-no" title="statement not covered" >            graphOffsetX = document.querySelector('#' + ctrl.sparklineChartId + ' g.c3-axis-y').getBoundingClientRect().right;</span>
<span class="cstat-no" title="statement not covered" >            x = Math.max(0, center + graphOffsetX - chartBox.left - Math.floor(width / 2));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            return {</span>
              top: top - height,
