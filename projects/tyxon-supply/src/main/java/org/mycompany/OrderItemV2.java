...
public class OrderItemV2 {
	...
	public boolean isWillAccumulate() {
		return willAccumulate;
	}
	public void setWillAccumulate(boolean willAccumulate) {
		this.willAccumulate = willAccumulate;
	}
